...
if __name__ == '__main__':
    ...
    st.markdown("_Disclaimer: This is an academic project which should only be used for academic purposes. The results generated by the app should not be taken seriously._")
